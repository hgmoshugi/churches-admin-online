<?php
error_reporting(0);
 $db = mysqli_select_db('cman_db',@mysqli_connect('localhost','root','')); ?>
<?php
...
values('$fname','$sname','$lname','$gender','$birthday','$residence','$pob','$ministry','$mobile','$email','uploads/none.png','$password','$mobile',$id')")or die(mysqli_error());
...
<script>
window.location = "index.php";
$.jGrowl("Member Successfully added", { header: 'members add' });
</script>
<?php
}
}
